...
|---|---|
| Scrape result | **FAIL** |
| Last scrape log line | `----- 2026-08-28 11:57:34 refresh FAILED (exit 1)` |
...
----- 2026-08-28 11:57:34 refresh FAILED (exit 1)
```

## Recent push errors

```
2026-08-28 12:26:52  BLOCKED: baseline regression
2026-08-28 12:36:56  BLOCKED: baseline regression
2026-08-28 12:46:59  BLOCKED: baseline regression
```
