...
|---|---|
| Scrape result | **FAIL** |
| Last scrape log line | `----- 2026-08-24 15:11:12 refresh exit 3` |
| index.html modified | 2026-08-24 12:31:59 BST |
| Classes in index.html | 1961 |

## Last scrape failure

```
----- 2026-08-20 14:42:41 refresh start (python: /usr/bin/python3)
...
----- 2026-08-20 14:42:41 refresh exit 3
