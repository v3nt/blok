...
|---|---|
| Scrape result | **FAIL** |
| Last scrape log line | `----- 2026-09-18 00:40:34 refresh FAILED (exit 1)` |
| index.html modified | 2026-09-17 22:11:21 BST |
| Classes in index.html | 2013 |

## Last scrape failure

```
  File "/Users/danielcrabbe14/Sites/jynk/blok/scraper/refresh.py", line 604, in main
    browser, ctx = start(None)
  File "/Users/danielcrabbe14/Sites/jynk/blok/scraper/refresh.py", line 577, in start
...
----- 2026-09-18 00:40:34 refresh FAILED (exit 1)
```
