...
|---|---|
| Scrape result | **FAIL** |
| Last scrape log line | `----- 2026-09-08 02:42:00 refresh FAILED (exit 1)` |
| index.html modified | 2026-09-08 02:53:52 BST |
...
Call log:
  ...
  ! could not read upcoming reservations: Page.goto: Navigation to "https://classpass.com/profile/upcoming" is interrupted by another navigation to "chrome-error://chromewebdata/"
Call log:
  - navigating to "https://classpass.com/profile/upcoming", waiting until "load"

----- 2026-09-08 02:42:00 refresh FAILED (exit 1)
```

## Recent push errors

```
2026-09-08 02:53:52  BLOCKED: baseline regression
```
